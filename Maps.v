...
Proof.
  ...
  apply functional_extensionality.
  intros y.
  destruct (eqb_stringP x y) as [H | H].
  - rewrite H. unfold t_update. rewrite <- eqb_string_refl. reflexivity.
  - apply false_eqb_string in H. unfold t_update. rewrite H. reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  intros y.
  unfold t_update.
  destruct (eqb_string x1 y) eqn:E1.
  - destruct (eqb_string x2 y) eqn:E2.
    + apply eqb_string_true_iff in E1, E2.
      rewrite E1, E2 in H. contradiction.
    + reflexivity.
  - destruct (eqb_string x2 y) eqn:E2.
    + reflexivity.
    + reflexivity.
